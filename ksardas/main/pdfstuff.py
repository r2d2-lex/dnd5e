...
PDF_FORM_RECORDS = (
    ...
    ('Bonds', 'bonds', 'string', 'Привязанности'),
    ...
    ('ST Strength', 'st_strength', 'string', 'спасбросок силы'),
    ('ST Dexterity', 'st_dexterity', 'string', 'спасбросок знч'),
    ('ST Constitution', 'st_constitution', 'string', 'спасбросок знч'),
    ('ST Intelligence', 'st_intellegence', 'string', 'спасбросок знч'),
    ('ST Wisdom', 'st_wisdom', 'string', 'спасбросок знч'),
    ('ST Charisma', 'st_chrarisma', 'string', 'спасбросок знч'),
    ('Check Box 11', 'st_strength_box', 'checkbox', 'спасбросок чекбокс'),
    ('Check Box 18', 'st_dexterity_box', 'checkbox', 'спасбросок чекбокс'),
    ('Check Box 19', 'st_constitution_box', 'checkbox', 'спасбросок чекбокс'),
    ('Check Box 20', 'st_intellegence_box', 'checkbox', 'спасбросок чекбокс'),
    ('Check Box 21', 'st_wisdom_box', 'checkbox', 'спасбросок чекбокс'),
    ('Check Box 22', 'st_chrarisma_box', 'checkbox', 'спасбросок чекбокс'),
    ...
    ('AttacksSpellcasting', 'attacks_spellc', 'string', 'атаки и заклинания'),
    ...
    ('Passive', 'psv_perception', 'string', 'пассивная мудрость (внимательность)'),

    ('ProficienciesLang', 'profi_languages', 'string', 'прочие владения и языки'),
    ('Equipment', 'equipment', 'string', 'снаряжение'),
    ...
    ('Features and Traits', 'features_traits', 'string', 'умения и особенности'),
    # 2 page
