    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('race', models.CharField(max_length=20, verbose_name='Расса персонажа')),
                ...
                ('owner', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Владелец персонажа')),
            ],
            options={
                'ordering': ['-modified'],
            },
