...
class CharBase(models.Model):
    owner = models.ForeignKey('AdvUser', null=True, on_delete=models.PROTECT, verbose_name='Владелец персонажа')
    name = models.CharField(null=False, max_length=20, verbose_name='Имя персонажа')
